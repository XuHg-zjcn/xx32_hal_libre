...
COMFLAGS += -D$(device_family)$(product_type)$(device_subfamily)x$(flash_size_code2)#        #定义型号宏供HAL库使用
COMFLAGS += -g#                  #调试
...
LDFILE = $(DEV_DIR)/LDScript/$(shell echo $(device_family)$(product_type)$(device_subfamily)x$(flash_size_code) | tr A-Z a-z).ld
